...
const Contact = () => {
   ...
   const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ab068486-2a05-4a45-856d-ece967604969");
  ...
  return (
    <div className='contact'>
          <div className="contact-col">
            ...
            <ul>
              <li><img src={mail_icon} alt="" />sdeekshitha$70@gmail.com</li>
              <li><img src={phone_icon} alt="" />7829776014</li>
              <li><img src={location_icon} alt=""/> #10,20th MAIN ROAD Jc NAGAR kURUBARAHALLI</li>
            </ul>
        </div>
        <div className='contact-col'>
          <form onSubmit={onSubmit}>
            ...
            <input type="tel" name='phone' placeholder='Enter ur mobile number'
             required/>
